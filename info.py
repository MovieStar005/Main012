...
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/Movie_Star_Search')
...
SHORTENER_API2 = environ.get("SHORTENER_API2", "a952e2a13c10652e8f11a0d585bff48f1272c1fa")
...
request_channel = environ.get('REQUEST_CHANNEL', '-1002219302448')

REQUEST_CHANNEL = int(request_channel) if request_channel and id_pattern.search(request_channel) else None

UPI_PAY_LOGS = int(environ.get('UPI_PAY_LOGS', '-1008000054678'))

MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1001573863139'))
